...
<div className="relative bg-gray-100 px-4 md:px-20 py-4 md:py-10">
  ...
  {/* Agent Card Section */}
  <div className="hidden md:flex flex-col md:flex-row md:mt-40 mt-20 shadow-xl rounded-3xl overflow-hidden  w-full">
    {/* Left Section */}
...
<div className="flex flex-col bg-[rgb(206,32,39,255)] text-white shadow-lg rounded-2xl gap-4 mt-30 md:mt-4 md:hidden">
  {/* Agent Image */}
