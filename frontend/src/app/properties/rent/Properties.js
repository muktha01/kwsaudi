...
const PropertiesContent = () => {
  ...
  // Direct API fetch function for properties without caching
      ...
      const fetchFreshData = async (isBackgroundUpdate = false) => {
        try {
          ...
          if (isBackgroundUpdate) {
            console.log('✅ Rent page updated with latest data');
          }
            ...
            if (typeof window !== 'undefined') {
              ...
              if (cachedData) {
                try {
                  ...
                  console.warn('Error parsing cached rent data:', parseError);
                }
              }
            }
          }
