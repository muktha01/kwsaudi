...
export default function page() {
  ...
  OUR BELIEFS
          ...
          <p className="lg:mx-65 mx-4 font-[montserrat] tracking-[0em] lg:text-[0.9rem] text-[0.7rem] lg:font-normal font-semibold no-underline bg-transparent leading-[1.6]">
  ...
  To help cement this understanding we&rsquo;ve formalized a
    ...
    />
    <button className="bg-[rgb(206,32,39,255)] w-40 text-white px-8 py-1.5 text-[0.6rem] rounded-full block mx-auto lg:hidden mt-4 mb-4">
      JOIN US
    </button>
  </div>
      <Footer></Footer>
